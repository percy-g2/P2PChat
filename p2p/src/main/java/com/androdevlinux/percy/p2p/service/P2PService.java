 ...
 * <p>
 * <code>P2PService</code> is the group owner and it manages the group changes (connections and
 ...
 * </pre>
 */
public class P2PService implements PeerConnectedListener {
    ...
    public static final String SERVICE_NAME_VALUE = "P2P";
    ...
    private Map<String, P2PDevice> clientsConnected = new HashMap<>();
    ...
    /**
     * Return the <code>P2PService</code> instance. If the instance doesn't exist yet, it's
     * created and returned.
     *
     * @param context The application context.
     * @return The actual <code>P2PService</code> instance.
     */
    ...
    public void sendMessageToAllClients(final MessageWrapper message) {
        for (P2PDevice clientDevice : clientsConnected.values()) {
    ...
    private void onMessageReceived(MessageWrapper messageWrapper, InetAddress fromAddress) {
        if (messageWrapper.getMessageType().equals(MessageWrapper.MessageType.CONNECTION_MESSAGE)) {
            ...
            P2PDevice client = registrationMessageContent.getWroupDevice();
            ...
            P2PDevice client = disconnectionMessageContent.getWroupDevice();
    ...
    private void sendConnectionMessage(P2PDevice deviceToSend, P2PDevice deviceConnected) {
    ...
    private void sendDisconnectionMessage(P2PDevice deviceToSend, P2PDevice deviceDisconnected) {
    ...
    private void sendRegisteredDevicesMessage(P2PDevice deviceToSend) {
        List<P2PDevice> devicesConnected = new ArrayList<>();
        for (P2PDevice device : clientsConnected.values()) {
